...
def main():
    ...
    plotMetrics(N_tab, inerties_tab, 1, 'Variance totale en fonction de N', 'var_tot_4_clusters.jpg')
    plotMetrics(N_tab, errors_tab, 2, 'Plus grande erreur en fonction de N', 'erreur_max_4_clusters.jpg')
